        ...
        <footer className="bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white mt-20">
            <div className="container-custom py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-blue-200 mb-4 max-w-md">
                            Streamline your team's workflow with powerful project and task management tools.
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/dashboard" className="text-blue-200 hover:text-white transition-colors duration-200">
                                    Dashboard
                                </Link>
                            </li>
                            <li>
                                <a href="#features" className="text-blue-200 hover:text-white transition-colors duration-200">
                                    Features
                                </a>
                            </li>
                            <li>
                                <a href="#pricing" className="text-blue-200 hover:text-white transition-colors duration-200">
                                    Pricing
                                </a>
                            </li>
                        </ul>
                ...
                <div className="border-t border-white/10 mt-8 pt-8 text-center text-blue-200">
                    <p>&copy; {currentYear} TaskFlow. All rights reserved. Built with ❤️ for productive teams.</p>
                </div>
            </div>
        </footer>
    );
